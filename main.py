# Угадайка чисел
# Описание проекта: программа генерирует случайное число в диапазоне от 111 до 100100100 и просит пользователя угадать это число.
...
def get_number():
    ...
    if x > num:
        print('Загаданное число меньше введенного, попробуйте еще раз')
    elif x < num:
        print('Загаданное число больше введенного, попробуйте еще раз')
    else:
        print('ВЫ УГАДАЛИ! Это число: ', num)
